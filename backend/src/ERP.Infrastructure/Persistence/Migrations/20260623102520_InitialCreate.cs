        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_user_businesses_businesses_business_id",
                        column: x => x.business_id,
                        principalTable: "businesses",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_user_businesses_roles_role_id",
                        column: x => x.role_id,
                        principalTable: "roles",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_businesses_tenant_id_name",
                table: "businesses",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_businesses_business_id",
                table: "user_businesses",
                column: "business_id");

            migrationBuilder.CreateIndex(
                name: "ix_user_businesses_role_id",
                table: "user_businesses",
                column: "role_id");

            migrationBuilder.CreateIndex(
                name: "ix_user_businesses_user_id_business_id",
                table: "user_businesses",
